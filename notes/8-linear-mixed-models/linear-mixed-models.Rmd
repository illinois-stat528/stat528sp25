...
We now analyze this summary table. Lets start with the fixed effects. We see that income increases about 10% for each additional year of education (exp(0.104)). We see that age does not appear to be significant. For females, the reference level in this example, income increases about 8.5% a year, while for men, it increases about 8.5% - 2.6% = 5.9% a year. We see that, for this data, the incomes of men in 1978 are exp(1.150) = 3.16 times higher (far higher!) than for women. 
