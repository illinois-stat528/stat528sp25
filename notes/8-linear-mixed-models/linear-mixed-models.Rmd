...
This is not as simple for fixed effects models. We will start with the simplest possible example random effects model: a [one-way ANOVA](https://en.wikipedia.org/wiki/One-way_analysis_of_variance) design with a factor having $a$ levels:
$$
